              ...
              <div class="box-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="User/FormEdit.php?id_kasir=<?php echo $d['id_kasir']; ?>"><button class="btn btn-warning">EDIT DATA</button></td>
                    <td><a href="User/DeleteUser.php?id_kasir=<?php echo $d['id_kasir']; ?>" onclick="return confirm('Yakin Guys?')"><button class="btn btn-danger">DELETE DATA</button></td>
                  </tr>
                  <?php
                  }
                  ?>
