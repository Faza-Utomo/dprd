        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="inputuser.php"><i class="fa fa-plus"></i> Tambah Data</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
                      ...
                      <?php
                       ...
                       <select name="no_pesanan">
                         ...
                         <?php
                          ...
                          ?>
                          <option><?php echo $d["no_pesanan"]; ?></option>
                        <?php endwhile; ?>
                       </select>
                    </td>
                  </tr>
                      ...
                      <?php
                       ...
                       <select name="id_cust">
                         ...
                         <?php
                          while($d=mysqli_fetch_array($data)):;
                          ?>
                          <option><?php echo $d["id_cust"]; ?></option>
                        <?php endwhile; ?>
                       </select>
                    </td>
                  </tr>
                    ...
                    <td>
                      <?php
                       ...
                       <select name="id_kasir">
                         <option value="">Pilih ID Kasir</option>
                         <?php
                          while($d=mysqli_fetch_array($data)):;
                          ?>
                          <option><?php echo $d["id_kasir"]; ?></option>
                        <?php endwhile; ?>
                       </select>
                    </td>
                  </tr>
