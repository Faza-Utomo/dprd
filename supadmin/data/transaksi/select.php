              ...
              <div class="box-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="User/FormEdit.php?no_trans=<?php echo $d['no_trans']; ?>"><button class="btn btn-warning">EDIT DATA</button></td>
                    <td><a href="User/DeleteUser.php?no_trans=<?php echo $d['no_trans']; ?>" onclick="return confirm('Yakin Guys?')"><button class="btn btn-danger">DELETE DATA</button></td>
                  </tr>
                  <?php
                  }
                  ?>
