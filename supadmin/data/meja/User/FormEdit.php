            ...
            <div class="box">
              ...
              <div class="box-body">
                <?php
                  include '../../../../koneksi.php';
                  $no=$_GET['no_meja'];
                  $data = mysqli_query($koneksi , "SELECT*FROM meja WHERE no_meja='$no'");
                 ...
                 ?>
                  <form method="post" action="UpdateData.php">
                    <table>
                  <tr>
                    <td><input type="hidden" name="no_meja" value="<?php echo $d['no_meja']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Kapasitas : </td>
                    <td><input type="text" name="kapasitas" value="<?php echo $d['kapasitas']; ?>"></td>
                  </tr>
                  <tr>
