              ...
              <div class="box-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="User/FormEdit.php?no_meja=<?php echo $d['no_meja']; ?>"><button class="btn btn-warning">EDIT DATA</button></td>
                    <td><a href="User/DeleteUser.php?no_meja=<?php echo $d['no_meja']; ?>" onclick="return confirm('Yakin Guys?')"><button class="btn btn-danger">DELETE DATA</button></td>
                  </tr>
                  <?php
                  }
                  ?>
