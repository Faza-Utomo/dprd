      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="penjualan/Supplier/select.php"><i class="fa fa-table"></i> Laporan Data</a></li>
              <li><a href="penjualan/Supplier/User/inputuser.php"><i class="fa fa-plus"></i> Tambah Data</a></li>
            </ul>
          </li>
            ...
            <div class="box">
              ...
              <div class="box-body">
                <?php
                  include '../../../../koneksi.php';
                  $id=$_GET['id_cust'];
                  $data = mysqli_query($koneksi , "SELECT*FROM customer WHERE id_cust='$id'");
                 ...
                 ?>
                  <form method="post" action="UpdateData.php">
                    <table>
                  <tr>
                    <td><input type="hidden" name="id_cust" value="<?php echo $d['id_cust']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Nama Customer : </td>
                    <td><input type="text" name="nama_cust" value="<?php echo $d['nama_cust']; ?>"></td>
                  </tr>
                  <tr>
                    <td>No. Handphone : </td>
