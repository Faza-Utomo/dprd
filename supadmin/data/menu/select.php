      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../pemesanan/select.php"><i class="fa fa-table "></i> Laporan Data</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="select.php"><i class="fa fa-table"></i> Laporan Data</a></li>
            <li><a href="User/inputuser.php"><i class="fa fa-plus"></i> Tambah Data</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="box">
              ...
              <div class="box-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $d['kd_menu']; ?></td>
                    <td><?php echo $d['nama_menu']; ?></td>
                    <td><?php echo $d['harga']; ?></td>
                    <td><?php echo $d['jenis']; ?></td>
                    <td><img src="../Gambar/<?= $d['gambar']; ?>" width="120"></td>
                    <td><a href="User/FormEdit.php?kd_menu=<?php echo $d['kd_menu']; ?>"><button class="btn btn-warning">EDIT DATA</button></td>
                    <td><a href="User/DeleteUser.php?kd_menu=<?php echo $d['kd_menu']; ?>" onclick="return confirm('Yakin Guys?')"><button class="btn btn-danger">DELETE DATA</button></td>
                  </tr>
                  <?php
                  }
                  ?>
