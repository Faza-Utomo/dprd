            ...
            <div class="box">
              ...
              <div class="box-body">
                <?php
                  include '../../../../koneksi.php';
                  $no=$_GET['no_trans'];
                  $data = mysqli_query($koneksi , "SELECT*FROM transaksi WHERE no_trans='$no'");
                 ...
                 ?>
                  <form method="post" action="UpdateData.php">
                    <table>
                  <tr>
                    <td><input type="hidden" name="no_trans" value="<?php echo $d['no_trans']; ?>"></td>
                  </tr>
                  <tr>
                    <td>No. Pesanan : </td>
                    <td>
                      <?php
                       ...
                       <select name="no_pesanan">
                         <?php
                          while($d=mysqli_fetch_array($data)):;
                          ?>
                          <option value="<?php echo $d['no_pesanan'];?>"><?php echo $d["no_pesanan"]; ?></option>
                        <?php endwhile; ?>
                       </select>
                    </td>
                  </tr>
                      ...
                      <?php
                       ...
                       <select name="id_cust">
                         <?php
                          while($d=mysqli_fetch_array($data)):;
                          ?>
                          <option value="<?php echo  $d['id_cust']; ?>"><?php echo $d["id_cust"]; ?></option>
                        <?php endwhile; ?>
                       </select>
                    </td>
                  </tr>
                      ...
                      <?php
                       ...
                       <select name="id_kasir">
                         <?php
                          while($d=mysqli_fetch_array($data)):;
                          ?>
                          <option value="<?php echo $d['id_kasir']; ?>"><?php echo $d["id_kasir"]; ?></option>
                        <?php endwhile; ?>
                       </select>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td><input type="date" name="tgl_trans" value="<?php echo $d['tgl_trans']; ?>"></td>
                  </tr>
                  <tr>
