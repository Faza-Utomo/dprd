...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&family=Raleway:wght@300;400;500;600;700;900&family=Inter:wght@300;400;500;600;700;900&display=swap" rel="stylesheet">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-5 justify-content-center">
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item h-100">
              <div class="img">
                <img src="assets/img/dprd_1.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                ...
                <p>Bagian untuk melakukan pengisian formulir pengajuan dari Media</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item h-100">
              ...
              <div class="details position-relative">
                ...
                <p>Bagian untuk pengisian data kiriman dari Media</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row gy-5 mt-3 justify-content-center">
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="service-item h-100">
              <div class="img">
                <img src="assets/img/dprd_5.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                ...
                <p>Bagian untuk melihat rekap data pengajuan yang telah dilakukan oleh Media</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item h-100">
              <div class="img">
                <img src="assets/img/dprd_3.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                  <i class="bi bi-broadcast"></i>
                ...
                <p>Bagian untuk melihat rekap data kiriman harian dari Media</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item h-100">
              <div class="img">
                <img src="assets/img/dprd_4.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                  <i class="bi bi-broadcast"></i>
                ...
                <p>Bagian untuk melihat rekap data kiriman bulanan dari Media</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
          ...
          <div class="col-lg-6">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.10686550714!2d107.51728356487622!3d-6.835396826866748!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e36dbb0cc061%3A0x9aec9b1ec9d25e6!2sDPRD%20kabupaten%20Bandung%20Barat!5e0!3m2!1sid!2sid!4v1755573333461!5m2!1sid!2sid" width="600" height="370" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
